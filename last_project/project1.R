...
a <- charge_station[9, ]
b <- charge_station$X2020
years <- c(1, 2016, 2017, 2018, 2019, 2020, 2021)
...
barplot(result$X2019_cars, names = c("서울","인천","경기","강원","충북","충남","대전","세종","경북","대구","전북","전남",     
                                     "광주","경남","부산","울산","제주","합계"),                            # 2019전기차 대수 barplot
        main = "2019전국 전기차대수")
barplot(result$X2021_cars, names = c("서울","인천","경기","강원","충북","충남","대전","세종","경북","대구","전북","전남",
                                     "광주","경남","부산","울산","제주","합계"),                           # 2021 전기차 대수 barplot
        main = "2021전국 전기차대수")
...
str(result)
barplot(result$X2021_charge, names = c("서울","인천","경기","강원","충북","충남","대전","세종","경북","대구","전북","전남",
                                       "광주","경남","부산","울산","제주","합계"),
        main = "2019전국 충전소 개수")                    # 2021 전국 충전소 개수 barplot
